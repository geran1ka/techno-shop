...
export const renderRecommended = (recommended, data, id) => {
  ...
  if (goods.length) {
    ...
    container.className = "container recomended__container";
    ...
    const goodsCards = goods.map((item) => {
      ...
      itemImage.className = "goods-item__img";
      itemImage.src = `${API_URL}${item.images.present}`;
      ...
      itemBuy.className = "goods-item__wrapper";
      ...
      itemToCart.className = "goods-item__btn-ad-cart";
